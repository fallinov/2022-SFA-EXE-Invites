...
(function (document) {
    ...
    function ajouterInvite(e) {
        ...
        //Récupère le nom de l'invité et supprime les espace en début et fin de chaine.
    ...
    function supprimerInvite(e) {
        ...
        if(e.target.nodeName === 'BUTTON' && e.target.innerHTML === 'Supprimer') {
            ...
            //Demande un confirmation de la suppression de l'invité
    ...
    function confirmerInvite(e) {
        ...
        //Si on "décoche" l'invité et que le filtre masquer est actif => alors on cache le li immédiatement
